      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card className="col-span-full p-6 hover:shadow-lg transition-all bg-black/50 backdrop-blur supports-[backdrop-filter]:bg-black/30 border border-white/[0.08]">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-semibold text-gray-200">Latest Reviews</h3>
            <Link href="/business/dashboard/reviews" className="text-sm text-primary hover:underline">
              View All
            </Link>
          </div>
          ...
          {reviews.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {reviews.slice(0, 4).map((review) => (
                <div key={review._id} className="p-4 rounded-lg bg-white/5 border border-white/[0.08]">
                  ...
                  <h4 className="font-medium text-gray-200 mb-2 line-clamp-1">{review.title}</h4>
                  <p className="text-gray-400 text-sm mb-2 line-clamp-2">{review.body}</p>
